  ...
  return (
      ...
      <form className="popup event"   onSubmit={this.handleSubmit} >
        ...
        <div className="popup__picker">
          ...
          <input className="event__date-start input"  onChange={this.handleChange} name="startDate" required type="date"  />
          <input type="time" className="startTime_place input" name="startTimePlace"  onChange={this.handleChange} />
          <span className='line'></span>
          <input type="time" className="endTime_place input" name="endTimePlace" onChange={this.handleChange}/>
        </div>
        <div className="centerData">
          <img className="multiline" src="https://img.icons8.com/windows/32/000000/multiline-text.png" alt="mutiline" />
          <textarea type="text" className="multiline__text" onChange={this.handleChange}placeholder="Add description" name="description" cols="30" rows="3"></textarea>
        </div>
